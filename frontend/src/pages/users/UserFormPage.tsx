    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid gap-4 xl:grid-cols-2">
          ...
          <Card><CardHeader><CardTitle>Adresse</CardTitle></CardHeader><CardContent className="grid gap-4 md:grid-cols-2"><div className="md:col-span-2"><Field label="Adresse" value={form.address.line1} onChange={(value) => setAddressField("line1", value, setForm)} required /></div><div className="md:col-span-2"><Field label="Complément" value={form.address.line2 ?? ""} onChange={(value) => setAddressField("line2", value, setForm)} /></div><Field label="Code postal" value={form.address.postalCode} onChange={(value) => setAddressField("postalCode", value, setForm)} required /><Field label="Ville" value={form.address.city} onChange={(value) => setAddressField("city", value, setForm)} required /><Field label="Pays" value={form.address.country} onChange={(value) => setAddressField("country", value, setForm)} required /></CardContent></Card>
        </div>
