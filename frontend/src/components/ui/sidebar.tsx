        ...
        style={
          {
            ...
            "--sidebar-width-icon-floating": "calc(3rem + 1rem)",
            "--sidebar-width-icon-floating-padded": "calc(3rem + 1rem + 2px)",
            ...style,
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "rtl:-translate-x-1/2 in-data-[side=left]:cursor-w-resize",
...
const sidebarMenuButtonVariants = cva(
  [
    ...
    "data-active:text-sidebar-accent-foreground [&_svg]:size-4",
