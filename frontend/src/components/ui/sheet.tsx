    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          "duration-200 ease-in-out data-open:animate-in",
          "data-open:fade-in-0 data-closed:animate-out",
          "data-closed:fade-out-0 data-[side=bottom]:inset-x-0",
          ...
          "data-[side=left]:sm:max-w-sm data-[side=right]:inset-y-0",
          "data-[side=right]:right-0 data-[side=right]:h-full",
          "data-[side=right]:w-3/4 data-[side=right]:border-l",
          "data-[side=right]:sm:max-w-sm data-[side=top]:inset-x-0",
