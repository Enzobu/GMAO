  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "gap-1.5 rounded-md px-1.5 py-1 text-sm outline-hidden",
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "flex cursor-default items-center gap-1.5 rounded-md px-1.5",
        "py-1 text-sm outline-hidden select-none focus:bg-accent",
        "focus:text-accent-foreground",
        "not-data-[variant=destructive]:focus:**:text-accent-foreground",
        "data-inset:pl-7 data-open:bg-accent",
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        "z-50 min-w-[96px]",
        "origin-(--radix-dropdown-menu-content-transform-origin)",
        "overflow-hidden rounded-lg bg-popover p-1",
